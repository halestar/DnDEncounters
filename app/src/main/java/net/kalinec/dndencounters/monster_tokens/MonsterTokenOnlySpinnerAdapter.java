...
public class MonsterTokenOnlySpinnerAdapter extends BaseAdapter
{
    private List<MonsterToken> monsterTokens;
    private Context context;

    public MonsterTokenOnlySpinnerAdapter(Context context)
    {
    ...
    {
        convertView = LayoutInflater.from(context).inflate(R.layout.item_list_monster_tokens_only, parent, false);
